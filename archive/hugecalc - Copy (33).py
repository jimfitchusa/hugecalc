...
Supported operations: +, -, *, /, !, ^, sin, cos, sind, cosd, tan, tand
"""

VALID_OPERATORS = ('+', '-', '*', '/', '!', '^', 'sin', 'cos', 'sind', 'cosd', 'tan', 'tand')
...
def parse_and_validate():
    ...
    if is_piped:
        ...
        if len(sys.argv) == 3:
            if sys.argv[1] in ('sin', 'cos', 'sind', 'cosd', 'tan', 'tand'):
    ...
    if operation not in ('!', 'sin', 'cos', 'sind', 'cosd', 'tan', 'tand') and not _is_huge_digit(operand2):
