...
def _format_with_commas(number_str: str) -> str:
    ...
    # Intercept Scientific Notation
    scientific_suffix = ""
    if 'e' in number_str.lower():
        parts = number_str.lower().split('e')
        number_str = parts[0]
        scientific_suffix = 'e' + parts[1]
    ...
    return sign + formatted_whole + fractional_part + scientific_suffix
...
if __name__ == "__main__":
    ...
    if sys.stdout.isatty():
        ...
        formatted_result = _format_with_commas(str(final_hf))
