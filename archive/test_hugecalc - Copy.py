...
class TestHugeCalc(unittest.TestCase):
    ...
    def test_subtraction_negative_result(self):
        out, err, code = self.run_calc("10", "-", "50", env_vars={"HCFORMAT": "DEC"})
        self.assertEqual(code, 0)
    ...
    def test_machine_epsilon_bypass(self):
        ...
        out, err, code = self.run_calc("5e50", "+", "1e-10", env_vars={"HCFORMAT": "SCI"})
        self.assertEqual(code, 0)
...
# Import your specific classes and functions directly from your script
# (Assuming your file is named hugecalc.py)
